...
ggsave(Tosave, device = "tiff", units = "cm", width = 12, height = 10, filename = "F:/Corona-WorkingFromHome/Human-Muscle-Types/OurDataset/PaperFigures/Per_MyofiberInClusters.tif")
...
ggsave(Tosave, device = "tiff", units = "cm", width = 18, height = 8, filename = "F:/Corona-WorkingFromHome/Human-Muscle-Types/OurDataset/PaperFigures/Myofiber_t.ratio2.tif")
...
Tosave <- pheatmap::pheatmap (as.matrix (FiberClusterToPlot) *100, 
                              ...
                              angle_col = 90)
ggsave(Tosave, device = "tiff", units = "cm", width = 8, height = 10, filename = "F:/Corona-WorkingFromHome/Human-Muscle-Types/OurDataset/PaperFigures/Per_MyofiberInClusters-heatmap.tif")
```
...
tiff (filename = "F:/Corona-WorkingFromHome/Human-Muscle-Types/OurDataset/PaperFigures/Plot3D.tif", width = 8, height = 8, units = "cm", res = 650)
...
tiff (filename = "F:/Corona-WorkingFromHome/Human-Muscle-Types/OurDataset/PaperFigures/Plot3D_3.tif", width = 8, height = 8, units = "cm", res = 650)
par(mai = c(0.5, 0.5, 0.5, 0.5))
...
ggsave(Tosave, device = "tiff", units = "cm", width = 18, height = 6, filename = "F:/Corona-WorkingFromHome/Human-Muscle-Types/OurDataset/PaperFigures/Myofibertype_gene.tif")

Consensus <- "Consensus0.4"
filenames <- list.files (recursive = TRUE, path = "F:/Corona-WorkingFromHome/Human-Muscle-Types/OurDataset/MuscleDataset/Outputs/ConsensusWGCNA", pattern = paste0 (Consensus, ".csv"), full.names = TRUE)
...
P3 <- ggplot (ToPlot %>% filter (Clusters == "MyHC2X"), aes(x = M.7, y = per.n_Filt1_3*100)) +
  ...
  theme (panel.grid = element_blank (), 
         ...
         strip.text = element_text (size = 12, face = "bold"), legend.position = "none")
(Tosave <- plot_grid (P1, P2, P3, hjust = 0, vjust = 1, ncol = 3))
ggsave(Tosave, device = "tiff", units = "cm", width = 18, height = 6, filename = "F:/Corona-WorkingFromHome/Human-Muscle-Types/OurDataset/PaperFigures/Myofibertype_M.7.tif")
```
