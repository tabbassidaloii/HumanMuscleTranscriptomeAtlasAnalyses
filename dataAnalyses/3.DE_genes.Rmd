...
#Count the number of differentially expressed genes in each pairwise comparisons
...
#Remove cell type related genes
...
#Counte the proportion of differentially expressed genes (not cell type related) in each pairwise comparisons
ColPVAl <- colnames(DEtest_BatchMus)[grep(" p.value", colnames(DEtest_BatchMus))]
MusDissSim <- matrix(0, nrow = 7, ncol = 7) 
colnames(MusDissSim) <- rownames(MusDissSim) <- names(col.muscle) 
for(c in ColPVAl){
