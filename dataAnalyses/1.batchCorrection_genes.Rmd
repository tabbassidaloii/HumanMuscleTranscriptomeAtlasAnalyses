...
HTseqCount <- read.csv("inputs/countTables/primarySecuencingFragmentsPerGene", sep = "\t")
reSeqHTseqCount <- read.csv("inputs/countTables/reSecuencingFragmentsPerGene", sep = "\t")
...
save(D_Raw, D_BatchMus, HTseqCount, countAdjBatchMus, file =  "outputs/correctedGeneDatasetToAnalysis.RData")
